          ...
          <div className="h-70px w-[100%] rounded-xl border border-[#676573] bg-[#373448] flex items-center justify-center">
            <div className="bg-[#0F0D1A] my-[15px] flex items-center justify-center rounded-3xl">
              <h1 className="text-[20px] text-[#ffffff] md:px-[120px] px-[30px] py-[5px]">
                <span className="font-bold">Login:</span> Safe Trade World
              </h1>
            </div>
          </div>
                    ...
                    <div>
                      <form>
                        ...
                        <input
                          ...
                          className="text-[14px] texxt-[#ffffff]  border border-[#676573] mb-[20px] bg-[#393748] w-[97%] py-[10px] px-[20px] rounded-3xl"
                        />
                        <Link
                          to="/forgot"
                          className="text-[14px] text-[#c349ff] hover:text-[#5849FF] border-b hover:border-b-[#5849FF] transition-all duration-300 border-b-[#c349ff] mb-[20px]"
                        >
                          Forgot Password
                        </Link>
